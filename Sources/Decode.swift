...
/// Decode a JWT
public func decode(_ jwt: String, algorithms: [Algorithm], verify: Bool = true, audience: String? = nil, issuer: String? = nil, leeway: TimeInterval = 0) throws -> (header: JOSEHeader, payload: ClaimSet) {
  ...
  if verify {
    ...
    /// wxq 修改了返回值, 因为一些需求, 可能要用到 header 的
  return (header, claims)
}

/// Decode a JWT
public func decode(_ jwt: String, algorithm: Algorithm, verify: Bool = true, audience: String? = nil, issuer: String? = nil, leeway: TimeInterval = 0) throws -> (header: JOSEHeader, payload: ClaimSet) {
